...
// Visual Studio STL iterator debug workaround
#if !defined(LEAP_API_IMPLEMENTATION) && !defined(LEAP_API_INTERNAL) && !defined(LEAP_API_ITERATOR_DEBUGGING_OVERRIDE) && defined(_WIN32) && _HAS_ITERATOR_DEBUGGING
#error The Leap API is currently incompatible with Visual Studio STL iterators in debug mode. Work around this by setting _HAS_ITERATOR_DEBUGGING to 0 before including Leap.h
#endif
